...
function CaseCard({text}) {

  return (
    <div className='flex  justify-center w-[450px] flex-col items-start gap-5 bg-black p-[50px]  rounded-[45px] '>
      <div className=' w-full h-[250px] text-xl leading-normal text-white  text-start '>{text}</div>
      <a className='flex items-center gap-[15px] mt-[20px]'>

...
function CaseCard({text}) {
  ...
  return (
    <div className='flex w-[350px] flex-col items-start gap-5 bg-black px-[50px] py-[42px] rounded-[45px] '>
      <div className=' w-[250px] text-lg leading-normal text-white  text-start'>{text}</div>

...
function CaseStudiesHeading() {
  return (
    <div className=' mt-[140px] mb-20 px-[100px] flex items-start gap-10'>
      ...
      <div className='text-lg leading-normal font-normal w-[580px] flex-shrink-0'>Explore Real-Life Examples of Our Proven Digital Marketing Success through Our Case Studies</div>
    </div>
  );
}

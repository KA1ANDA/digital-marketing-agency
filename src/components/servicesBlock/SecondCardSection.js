...
import cardImage3 from './../../imgs/cardImages/cardImage3.png'
import cardImage4 from './../../imgs/cardImages/cardImage4.png'



function SecondCardSection() {
  return (
    <div data-aos="fade-right" className='flex flex-col  px-[20px] md:flex-row md:px-[100px] items-start gap-10  my-10'>
      ...
      <div className='flex flex-col  md:flex-row w-full md:w-[600px] p-[50px] justify-between items-center border rounded-[45px] bg-black shadow-[0px_5px_0px_0px] shadow-black'>
        <div className='flex flex-col justify-center items-start gap-[15px] md:gap-[93px]'>
          <div>
            <span className='flex flex-col items-start bg-white text-[30px] font-medium leading-normal px-[7px] gap-[10px] rounded-[7px] w-fit'>Social Media</span>
            <span className='flex flex-col items-start bg-white text-[30px] font-medium leading-normal px-[7px] gap-[10px] rounded-[7px] w-fit'>Marketing</span>
          </div>
        ...
        <div className='mt-[50px] w-[165px] h-[129px] md:w-[210px] md:h-[170px] flex justify-center items-center flex-shrink-0'>
          <img src={cardImage3}></img>
        </div>
      </div>


      <div className='flex flex-col  md:flex-row w-full md:w-[600px] p-[50px] justify-between items-center border rounded-[45px] bg-white shadow-[0px_5px_0px_0px] shadow-black'>
        <div className='flex flex-col justify-center items-start gap-[15px] md:gap-[93px]'>
          <div>
            <span className='flex flex-col items-start bg-green text-[30px] font-medium leading-normal px-[7px] gap-[10px] rounded-[7px] w-fit'>Email</span>
            <span className='flex flex-col items-start bg-green text-[30px] font-medium leading-normal px-[7px] gap-[10px] rounded-[7px] w-fit'>Marketing</span>
          </div>
          <a className='flex items-center gap-[15px]'>
            <svg xmlns="http://www.w3.org/2000/svg" width="41" height="41" viewBox="0 0 41 41" fill="none">

...
function Cta() {
  ...
  return (
    <div className='flex w-full px-[20px] md:px-[100px] justify-center items-center -gap-[715px] mt-[100px] bg-green  '>
      <div className='flex p-[50px] md:w-[1240px] md:h-[347px] md:px-[60px] items-center gap-[275px] flex-shrink-0 rounded-[45px] bg-white'>
